...
if __name__ == "__main__":
    ...
    imu_sub = message_filters.Subscriber('/djiros/imu', Imu)
    velo_sub = message_filters.Subscriber('/djiros/velo', Vector3Stamped)
    gps_sub = message_filters.Subscriber('/djiros/gps', NavSatFix)
